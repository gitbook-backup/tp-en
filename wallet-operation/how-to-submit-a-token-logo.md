...
Please be noted that there will be **3000 TPT** for **every token logo/info** submission as a donation, and this transfer is **irreversible**. Please follow the steps below to transfer after the above preparation is completed \(BSC chain is taken as an example here\): ‌
